CREATE TABLE [log].[tbmARC_PHOTO] (
    ...
    [fdOP_DATE]       DATETIME       CONSTRAINT [DF_tbmARC_PHOTO_fdOP_DATE] DEFAULT (getdate()) NULL,
    [fsOP_BY]         VARCHAR (50)   NULL,
    CONSTRAINT [PK_tbmARC_PHOTO] PRIMARY KEY CLUSTERED ([fnID] ASC)
) TEXTIMAGE_ON [PRIMARY];


GO
CREATE NONCLUSTERED INDEX [IDX_1]
    ON [log].[tbmARC_PHOTO]([fsFILE_NO] ASC);
