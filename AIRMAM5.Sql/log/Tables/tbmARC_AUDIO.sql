CREATE TABLE [log].[tbmARC_AUDIO] (
    ...
    [fdOP_DATE]          DATETIME        CONSTRAINT [DF_tbmARC_AUDIO_fdOP_DATE] DEFAULT (getdate()) NULL,
    [fsOP_BY]            VARCHAR (50)    NULL,
    CONSTRAINT [PK_tbmARC_AUDIO] PRIMARY KEY CLUSTERED ([fnID] ASC)
) TEXTIMAGE_ON [PRIMARY];


GO
CREATE NONCLUSTERED INDEX [IDX_1]
    ON [log].[tbmARC_AUDIO]([fsFILE_NO] ASC);
