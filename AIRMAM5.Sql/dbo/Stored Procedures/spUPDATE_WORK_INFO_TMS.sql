...
-- =============================================
-- 描述:	修改NEWS主檔資料
-- 記錄:	<2013/09/14><Eric.Huang><新增本預存>
-- ※本預存僅供轉檔AP使用
-- =============================================
CREATE PROCEDURE [dbo].[spUPDATE_WORK_INFO_TMS]
	@fnWORK_ID		bigint,	
	...
	@_sDESCRIPTION	nvarchar(50),	/*傳入空白則不更新*/	
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			@_sDESCRIPTION		= CASE WHEN (@_sDESCRIPTION	 = '')			THEN _sDESCRIPTION ELSE @_sDESCRIPTION END,
