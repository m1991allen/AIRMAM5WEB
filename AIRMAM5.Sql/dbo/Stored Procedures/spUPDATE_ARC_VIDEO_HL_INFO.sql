...
-- =============================================
CREATE PROCEDURE [dbo].[spUPDATE_ARC_VIDEO_HL_INFO]
	...
	BEGIN TRY
		...
		BEGIN
			...
			FROM
				tbmARC_VIDEO
			WHERE 
				(@TYPE = 'V') AND (fsFILE_NO = @fsFILE_NO)
		...
		BEGIN
			...
			FROM
				tbmARC_AUDIO
			WHERE 
				(@TYPE = 'A') AND (fsFILE_NO = @fsFILE_NO)
		...
		BEGIN
			...
			FROM
				tbmARC_PHOTO
			WHERE 
				(@TYPE = 'P') AND (fsFILE_NO = @fsFILE_NO)
		...
		--		tbmARC_DOC
		--	WHERE 
		--		(@TYPE = 'D') AND (fsFILE_NO = @fsFILE_NO)
