...
CREATE PROCEDURE [dbo].[spINSERT_ARC_DOC]
	...
	--@fsFILE_SIZE_1			VARCHAR(50)  = '',
	--@fsFILE_SIZE_2			VARCHAR(50)  = '',		
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			INSERT
				...
				(fsFILE_NO,     fsTITLE,	   fsDESCRIPTION,	fnFILE_SECRET	,fsSUBJECT_ID,   fsFILE_STATUS,
				 fsFILE_TYPE ,  fsFILE_SIZE ,  
				 fsFILE_PATH ,  fxMEDIA_INFO , fsCONTENT,	    fdFILE_CREATED_DATE, 
				 fdFILE_UPDATED_DATE,fdCREATED_DATE, fsCREATED_BY,
			...
			VALUES
				...
				(@fsFILE_NO,     @fsTITLE,	 @fsDESCRIPTION, @fnFILE_SECRET,  @fsSUBJECT_ID,	@fsFILE_STATUS, 
				 @fsFILE_TYPE ,  @fsFILE_SIZE , 
				 @fsFILE_PATH ,  @fxMEDIA_INFO , @fsCONTENT,     @fdFILE_CREATED_DATE, 
				 @fdFILE_UPDATED_DATE,GETDATE(), @fsCREATED_BY,
				 @fsATTRIBUTE1,  @fsATTRIBUTE2,  @fsATTRIBUTE3,  @fsATTRIBUTE4,  @fsATTRIBUTE5,  @fsATTRIBUTE6,
				 @fsATTRIBUTE7,  @fsATTRIBUTE8,  @fsATTRIBUTE9,  @fsATTRIBUTE10, @fsATTRIBUTE11, @fsATTRIBUTE12,
				 @fsATTRIBUTE13, @fsATTRIBUTE14, @fsATTRIBUTE15, @fsATTRIBUTE16, @fsATTRIBUTE17, @fsATTRIBUTE18,
				 @fsATTRIBUTE19, @fsATTRIBUTE20, @fsATTRIBUTE21, @fsATTRIBUTE22, @fsATTRIBUTE23, @fsATTRIBUTE24,
		...
		BEGIN
			--判斷此預編用的樣板是否與此聲音樣板相同
			IF((SELECT [fnTEMP_ID_DOC] FROM [dbo].[tbmDIRECTORIES] WHERE fnDIR_ID = (SELECT fnDIR_ID FROM tbmSUBJECT WHERE fsSUBJ_ID = @fsSUBJECT_ID)) = 
			...
			BEGIN
				...
				SELECT RESULT = 'ERROR:此文件需要的樣板與預編詮釋資料的樣板不符'
