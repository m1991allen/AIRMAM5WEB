...
-- =============================================
-- 描述:	依照DIR_ID取出DIRECTORIES主檔資料 BY SUBJ_ID/LOGIN_ID				※此預存修改前請先與富元討論
-- 記錄:	<2012/05/17><Eric.Huang><新增此版程式Logic>
-- 記錄:	<2012/07/11><Eric.Huang><新增_sDIR_LOCK_YN儲存點選的DIR的fsSHOWTYPE 供 obj_ARC_AUTH.cs 在判斷user進入VAPD檢視視窗
--                               有無按鈕權限時用。>
-- 記錄:	<2016/10/28><David.Sin><修改查詢方法，加入是否可以調用>
-- =============================================
CREATE PROCEDURE [dbo].[spGET_DIRECTORIES_BY_SUBJ_ID_LOGIN_ID_AUTHORITY]
