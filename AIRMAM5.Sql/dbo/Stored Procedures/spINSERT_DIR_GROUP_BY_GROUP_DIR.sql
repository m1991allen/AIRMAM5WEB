...
-- =============================================
CREATE PROCEDURE [dbo].[spINSERT_DIR_GROUP_BY_GROUP_DIR]
	@fnDIR_ID			BIGINT,
...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO
			tbmDIR_GROUP(fnDIR_ID,fsGROUP_ID,fsLIMIT_SUBJECT,fsLIMIT_VIDEO,fsLIMIT_AUDIO,
			fsLIMIT_PHOTO,fsLIMIT_DOC,fdCREATED_DATE,fsCREATED_BY)
		VALUES
			(@fnDIR_ID,@fsGROUP_ID,@fsLIMIT_SUBJECT,@fsLIMIT_VIDEO,@fsLIMIT_AUDIO,
