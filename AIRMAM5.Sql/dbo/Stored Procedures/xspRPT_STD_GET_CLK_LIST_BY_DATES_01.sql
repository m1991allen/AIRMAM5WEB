...
-- =============================================
CREATE PROCEDURE [dbo].[xspRPT_STD_GET_CLK_LIST_BY_DATES_01]
	@SDATE		DATE,
	@EDATE		DATE,
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT	[fsTYPE], 
				...
				dbo.fnGET_FILE_INFO_BY_DataType_AND_FILE_NO('V', fsFILE_NO), '1900/1/1', COUNT([fnARC_CLK_ID]),
		...
		ORDER BY _ORDER, fsFILE_NO, fsSUBJ_ID
