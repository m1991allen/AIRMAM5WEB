...
--			<2016/11/23><David.Sin><調整欄位>
--			<2019/05/30><David.Sin><增加參數fnPRE_ID，若大於0則使用預編詮釋資料>
-- =============================================
CREATE PROCEDURE [dbo].[spINSERT_ARC_AUDIO]
	...
	@fnALBUM_YEAR		NVARCHAR(100) = NULL,
	...
	BEGIN TRY
		...
		BEGIN
			INSERT
				...
				(fsFILE_NO,     fsTITLE,	fsDESCRIPTION, fnFILE_SECRET,	fsSUBJECT_ID, fsFILE_STATUS,
				 fsFILE_TYPE ,  fsFILE_TYPE_H, fsFILE_TYPE_L, fsFILE_SIZE ,  fsFILE_SIZE_H, 
				 fsFILE_SIZE_L,	fsFILE_PATH ,  fsFILE_PATH_H, fsFILE_PATH_L,  fxMEDIA_INFO,	
				 fsALBUM,		fsALBUM_TITLE,	fsALBUM_ARTISTS,fsALBUM_PERFORMERS,fsALBUM_COMPOSERS,
				 fnALBUM_YEAR,	fsALBUM_COPYRIGHT,	fsALBUM_GENRES,	fsALBUM_COMMENT,fcALBUM_PICTURE,
				 fdBEG_TIME,	fdEND_TIME,		fdDURATION,	fdCREATED_DATE,		fsCREATED_BY,
			...
			VALUES
				...
				(@fsFILE_NO,     @fsTITLE,		 @fsDESCRIPTION, @fnFILE_SECRET,	@fsSUBJECT_ID,  @fsFILE_STATUS, 
				 ...
				 @fsALBUM,		@fsALBUM_TITLE,	@fsALBUM_ARTISTS,@fsALBUM_PERFORMERS,@fsALBUM_COMPOSERS,
				 @fnALBUM_YEAR,	@fsALBUM_COPYRIGHT,	@fsALBUM_GENRES,	@fsALBUM_COMMENT,@fcALBUM_PICTURE,
				 @fdBEG_TIME, @fdEND_TIME, @fdDURATION,GETDATE(), @fsCREATED_BY,
				 @fsATTRIBUTE1,  @fsATTRIBUTE2,  @fsATTRIBUTE3,  @fsATTRIBUTE4,  @fsATTRIBUTE5,  @fsATTRIBUTE6,
				 @fsATTRIBUTE7,  @fsATTRIBUTE8,  @fsATTRIBUTE9,  @fsATTRIBUTE10, @fsATTRIBUTE11, @fsATTRIBUTE12,
				 @fsATTRIBUTE13, @fsATTRIBUTE14, @fsATTRIBUTE15, @fsATTRIBUTE16, @fsATTRIBUTE17, @fsATTRIBUTE18,
				 @fsATTRIBUTE19, @fsATTRIBUTE20, @fsATTRIBUTE21, @fsATTRIBUTE22, @fsATTRIBUTE23, @fsATTRIBUTE24,
		...
		BEGIN
			--判斷此預編用的樣板是否與此聲音樣板相同
			IF((SELECT [fnTEMP_ID_AUDIO] FROM [dbo].[tbmDIRECTORIES] WHERE fnDIR_ID = (SELECT fnDIR_ID FROM tbmSUBJECT WHERE fsSUBJ_ID = @fsSUBJECT_ID)) = 
			...
			BEGIN
				INSERT
					...
					(fsFILE_NO,     fsTITLE,	fsDESCRIPTION, fnFILE_SECRET,	fsSUBJECT_ID, fsFILE_STATUS,
					 ...
					 fsATTRIBUTE55, fsATTRIBUTE56, fsATTRIBUTE57, fsATTRIBUTE58, fsATTRIBUTE59, fsATTRIBUTE60)
				SELECT
					 @fsFILE_NO,fsTITLE,fsDESCRIPTION,0,@fsSUBJECT_ID,@fsFILE_STATUS, 
					 @fsFILE_TYPE ,  @fsFILE_TYPE_H, @fsFILE_TYPE_L, @fsFILE_SIZE ,  @fsFILE_SIZE_H, 
					 @fsFILE_SIZE_L, @fsFILE_PATH ,  @fsFILE_PATH_H, @fsFILE_PATH_L, @fxMEDIA_INFO, 
					 @fsALBUM,		@fsALBUM_TITLE,	@fsALBUM_ARTISTS,@fsALBUM_PERFORMERS,@fsALBUM_COMPOSERS,
					 @fnALBUM_YEAR,	@fsALBUM_COPYRIGHT,	@fsALBUM_GENRES,	@fsALBUM_COMMENT,@fcALBUM_PICTURE, 
			...
			BEGIN
				...
				SELECT RESULT = 'ERROR:此聲音需要的樣板與預編詮釋資料的樣板不符'
