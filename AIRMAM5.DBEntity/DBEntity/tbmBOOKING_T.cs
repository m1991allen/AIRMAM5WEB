...
namespace AIRMAM5.DBEntity.DBEntity
{
    ...
    public partial class tbmBOOKING_T
    {
        ...
        public tbmBOOKING_T()
        {
            this.tbmBOOKING = new HashSet<tbmBOOKING>();
        }
    
        public int fnID { get; set; }
        public string fsNAME { get; set; }
        public string fsTRAN_TYPE { get; set; }
        public string fsPATH { get; set; }
        public string fsPROFILE_V { get; set; }
        public string fsPROFILE_A { get; set; }
        public string fsWATERMARK { get; set; }
