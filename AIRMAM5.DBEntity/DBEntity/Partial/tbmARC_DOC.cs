...
{
    /// <summary>
    /// 媒資-文件主檔資料表 tbmARC_DOC
    /// </summary>
    [MetadataType(typeof(tbmARC_DOCMetadata))]
    public partial class tbmARC_DOC
    {
        public tbmARC_DOC()
        {
            ...
            fsCONTENT = string.Empty;
            fdFILE_CREATED_DATE = DateTime.Now;
            fdFILE_UPDATED_DATE = null;
        ...
        public class tbmARC_DOCMetadata
        {
            ...
            public DateTime fdFILE_CREATED_DATE { get; set; }
            public DateTime? fdFILE_UPDATED_DATE { get; set; }
