...
namespace AIRMAM5.DBEntity.DBEntity
{
    ...
    public partial class tblHUBCONNECTION
    {
        public string fsUSER_ID { get; set; }
        public string fsHUB_CONNECTION_ID { get; set; }
        public System.DateTime fdONLINEED_TIME { get; set; }
        public Nullable<System.DateTime> fdUPDATED_TIME { get; set; }
