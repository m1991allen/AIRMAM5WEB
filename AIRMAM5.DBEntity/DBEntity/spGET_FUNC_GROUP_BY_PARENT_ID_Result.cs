...
namespace AIRMAM5.DBEntity.DBEntity
{
    ...
    public partial class spGET_FUNC_GROUP_BY_PARENT_ID_Result
    {
        ...
        public string fsFUNCTION_NAME { get; set; }
        public string fsGROUP_NAME { get; set; }
        public string fsPARENT_ID { get; set; }
        public string fsPARENT_NAME { get; set; }
